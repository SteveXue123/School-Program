from playerRainbow import player, gambler, businessman, shuffler, elderly, venturer, programmer, chemist
from gameRainbow import game
import numpy as np
import time
...
if __name__ == "__main__":
    ...
    for i in range(times):
        players = [programmer(10000, .625), programmer(10000, .625), programmer(10000, .625)]
